...
for subindex = 1:size(folderNames,2)
   ...
   prepro_scadsandspline_log(rawfile, datfile, 'getcon_condispa1', 12, {'1' '2' '3' '4' '5' '6'}, [-.6 2.8], [3  32], [3 9], 1, 'GSN-HydroCel-128.sfp', 'HC1-128.ecfg');
   prepro_scadsandspline_log(rawfile, datfile, 'getcon_condispa2', 12, {'7' '8' '9' '10' '11' '12'}, [-.6 2.8], [3  32], [3 9], 1, 'GSN-HydroCel-128.sfp', 'HC1-128.ecfg');
